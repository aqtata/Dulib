...
public:
	...
	virtual BOOL WINAPI IsHookChildMouseMsg() { return m_bHookChildMouseMsg; }
	...
	virtual void WINAPI SetHookChildMouseMsg(BOOL bHook){ m_bHookChildMouseMsg = bHook; }
